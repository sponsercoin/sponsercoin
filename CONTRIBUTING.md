Contributing to Sponsercoin Core
==================================

The Sponsercoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Sponsercoin Core project, and is not to be
confused with overall Sponsercoin Network Protocol consensus changes.

Whether a pull request is merged into Sponsercoin Core rests with the project merge
...
Patches that change Sponsercoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sponsercoin consensus, it must have been
...
The project leader is the release manager for each Sponsercoin Core release.
