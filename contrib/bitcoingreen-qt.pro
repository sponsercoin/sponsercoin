...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/sponsercoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/sponsercoin-cli.cpp \
           src/sponsercoin-tx.cpp \
           src/sponsercoin.cpp \
           src/db.cpp \
           ...
           src/qt/sponsercoin.cpp \
           src/qt/sponsercoinstrings.cpp \
...
RESOURCES += src/qt/sponsercoin.qrc src/qt/sponsercoin_locale.qrc

TRANSLATIONS += src/qt/locale/sponsercoin_bg.ts \
                src/qt/locale/sponsercoin_de.ts \
                src/qt/locale/sponsercoin_en.ts \
                src/qt/locale/sponsercoin_es.ts \
                src/qt/locale/sponsercoin_fi.ts \
                src/qt/locale/sponsercoin_fr.ts \
                src/qt/locale/sponsercoin_it.ts \
                src/qt/locale/sponsercoin_ja.ts \
                src/qt/locale/sponsercoin_pl.ts \
                src/qt/locale/sponsercoin_pt.ts \
                src/qt/locale/sponsercoin_ru.ts \
                src/qt/locale/sponsercoin_sk.ts \
                src/qt/locale/sponsercoin_sv.ts \
                src/qt/locale/sponsercoin_vi.ts \
                src/qt/locale/sponsercoin_zh_CN.ts \
                src/qt/locale/sponsercoin_zh_TW.ts
