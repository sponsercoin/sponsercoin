...
This means one can have an always-on sponsercoind instance running, and another local sponsercoind/sponsercoin-qt instance which connects to this node and receives blocks from it.
