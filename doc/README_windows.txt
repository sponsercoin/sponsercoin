...
Intro
-----
Sponsercoin (SPON) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Sponsercoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run sponsercoin-qt.exe.

Sponsercoin Core is the original Sponsercoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Sponsercoin transactions;
