...
Sponsercoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<sponsercoin_address\> \<monthly_payment_sponsercoin\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<sponsercoin_address\> \<monthly_payment_sponsercoin\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a Sponsercoin initiative
 * vote-alias         - Vote on a Sponsercoin initiative
 * vote               - Vote on a Sponsercoin initiative/budget
