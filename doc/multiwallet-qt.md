...
In order to support loading of multiple wallets in sponsercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sponsercoin.cpp.
...
Changes to sponsercoin.cpp
----------------------
sponsercoin.cpp is the entry point into sponsercoin-qt, and as such, will require some minor modifications to provide hooks for
