...
This mechanism has been integrated into Bitcore-Node-SponserCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sponsercoin/insight-api-sponsercoin#web-socket-api](https://github.com/sponsercoin/insight-api-sponsercoin#web-socket-api)
* API: [https://github.com/sponsercoin/insight-api-sponsercoin#swifttx-transactions](https://github.com/sponsercoin/insight-api-sponsercoin#swifttx-transactions)
...
By default, the Sponsercoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sponsercoin Core daemon:
