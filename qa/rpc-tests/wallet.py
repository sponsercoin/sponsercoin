...
#   c) node1 mines 32 blocks, so now node 0 has 500000SPON, node 1 has 4250SPON, node2 has none.
#   d) node0 sends 601 SPON to node2, in two transactions (301 SPON, then 300 SPON).
