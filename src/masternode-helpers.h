...
// Copyright (c) 2017-2018 The Sponsercoin developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is SPON collateral - checking if valid masternode)
