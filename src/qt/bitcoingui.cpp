                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sponsercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sponsercoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sponsercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sponsercoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sponsercoin"));
    ...
    openAction->setStatusTip(tr("Open a sponsercoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sponsercoin Core help message to get a list with possible Sponsercoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sponsercoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sponsercoin network", "", count));
}
...
{
    QString strTitle = tr("Sponsercoin Core"); // default title
