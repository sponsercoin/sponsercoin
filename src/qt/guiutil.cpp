...
{
    // return if URI is not valid or is no sponsercoin: URI
...
{
    // Convert sponsercoin:// to sponsercoin:
    //
    //    Cannot handle this later, because sponsercoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open sponsercoin.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SponserCoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for SponserCoin.lnk
...
{
    return GetAutostartDir() / "sponsercoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a sponsercoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=SponserCoin\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the sponsercoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add sponsercoin app to startup item list
