...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Sponsercoin Core"),
     ...
     * override -datadir in the sponsercoin.conf file in the default data directory
     * (to be consistent with sponsercoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
