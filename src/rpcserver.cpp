...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Sponsercoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Sponsercoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Sponsercoin features */
        {"sponsercoin", "masternode", &masternode, true, true, false},
        {"sponsercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sponsercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sponsercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sponsercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sponsercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sponsercoin", "startmasternode", &startmasternode, true, true, false},
        {"sponsercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sponsercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sponsercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sponsercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sponsercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sponsercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sponsercoin", "mnbudget", &mnbudget, true, true, false},
        {"sponsercoin", "preparebudget", &preparebudget, true, true, false},
        {"sponsercoin", "submitbudget", &submitbudget, true, true, false},
        {"sponsercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sponsercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sponsercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sponsercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sponsercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sponsercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sponsercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sponsercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"sponsercoin", "mnsync", &mnsync, true, true, false},
        {"sponsercoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> sponsercoin-cli " + methodname + " " + args + "\n";
}
