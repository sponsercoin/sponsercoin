...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sponsercoin Core sponsercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sponsercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sponsercoin transaction") + "\n" +
                               "  sponsercoin-tx [options] -create [commands]   " + _("Create hex-encoded sponsercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sponsercoin transaction
